...
class Reservation(models.Model):
    ...
    user = models.ForeignKey(User, on_delete=models.CASCADE, verbose_name="Solicitante")
    ...
    def clean(self):
        if self.end <= self.start:
            raise ValidationError("O horário de término deve ser posterior ao início.")
        ...
        if self.id:
            conflicting_reservations = conflicting_reservations.exclude(id=self.id)
