...
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': [
        'rest_framework.authentication.TokenAuthentication',  # <--- Para Apps/APIs
...
DATABASES = {
    'default': config(
        'DATABASE_URL', default=default_db_url, cast=dj_database_url.parse
    )
}
...
# Hora: 14:00 (Formato 24h)
TIME_FORMAT = 'H:i'
TIME_INPUT_FORMATS = ['%H:%M']

# Data e Hora: 31/12/2025 14:00
